...
#create the data for default stackrc file
...
#create endpoint
openstack --os-url http://localhost:35357/v3 --os-identity-api-version 3 --os-token=ADMIN  endpoint create  keystone  public  http://localhost:35357/
openstack --os-url http://localhost:35357/v3 --os-identity-api-version 3 --os-token=ADMIN  endpoint create  keystone  internal http://localhost:35357/
openstack --os-url http://localhost:35357/v3 --os-identity-api-version 3 --os-token=ADMIN  endpoint create  keystone  admin  http://localhost:35357/
